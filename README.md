...
is a group of elements that gives meaning to a web page

2. What are the 4 areas of the box model?
padding. margin. border contetn

3. While using flexbox, what axis does the following property work on: ```align-items: center```?
centering the selected contetnt
4. Explain why git is valuable to a team of developers.
allows a group of developesrs to SEE EACH OTHEERS and manage everything in a great online environment
5. Define mobile-first design in your own words.
means it focuses on the mobile devices first as you start developping a web page or application
